...
show_available_drives() {
    ...
    echo -e "${YELLOW}Drive${NC}\t${YELLOW}  Size${NC}"
    echo "----------------"
...
echo ""
echo -e "${GREEN}╭─────────────────────────────────────────╮${NC}"
echo -e "${GREEN}│${NC} https://glitchlinux.com - ${YELLOW}CLI SQUASHER  ${GREEN}│${NC}"
echo -e "${GREEN}│${NC}  filesystem.squashfs remaster utility   ${GREEN}│${NC}"
echo -e "${GREEN}│${NC} Supports live boot & Persistent install ${GREEN}│${NC}" 
echo -e "${GREEN}╰─────────────────────────────────────────╯${NC}"
echo ""
...
# Get user input
echo
echo -e "${YELLOW}Select disk or partition:${NC}"
echo

# Drive selection
while true; do
    echo -n "Enter path where to create the module (e.g. /mnt, /tmp /.): "
    read DRIVE_PATH
